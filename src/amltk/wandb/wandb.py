...
class WandbParams:
    ...
    [`WandbPlugin`][amltk.wandb.WandbPlugin] to initialize a run. It can be
    modified using the [`modify()`][amltk.wandb.WandbParams.modify] method.
...
class WandbLiveRunWrap:
    ...
    [`WandbTrialTracker`][amltk.wandb.WandbTrialTracker] to wrap
    the target function.
    """
