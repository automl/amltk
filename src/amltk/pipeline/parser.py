...
class Parser(ABC, Generic[Space]):
    ...
    !!! example "Abstract Methods"
        ...
        * [`parse_space`][amltk.pipeline.parser.Parser.parse_space]:
            Parse a search space into a space.
        * [`empty`][amltk.pipeline.parser.Parser.empty]:
            Get an empty space.
        * [`insert`][amltk.pipeline.parser.Parser.insert]:
            Insert a space into another space, with a possible prefix + delimiter.
        * [`set_seed`][amltk.pipeline.parser.Parser.set_seed]:
        ...
        !!! note
            ...
            * [`condition`][amltk.pipeline.parser.Parser.condition]:
    ...
    See Also:
        * [`SpaceAdapter`][amltk.pipeline.space.SpaceAdapter]
            Together with implementing the [`Sampler`][amltk.pipeline.sampler.Sampler]
    ...
    def parse_choice(self, step: Choice) -> Space:
        ...
        Note:
            ...
            the class docstring [here][amltk.pipeline.parser.Parser] for more
            information.
